            ...
            <table border="1" cellpadding="10" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-danger" href="../ControladorAprendiz?accion=editar&id=%><%=pr.getCodprogra()%>">editar</a>
                            <a class="btn btn-warning" href="../ControladorAprendiz?accion=eliminar&id=%<%=pr.getCodprogra()%>">eliminar</a>
                        </td>
