...
public class ProgramaDao implements MePrograma{
    ...
    public Programa listar(int id) {
        String sql="Select * from Programa where codprograma="+id;
        try{
            cn=co.getConnection();
    ...
    public boolean actualizarpro(Programa pro) {
        String sql="update programa set nomprograma='"+pro.getNomprogra()+"' where codprograma="+pro.getCodprogra();
        try{
            cn = co.getConnection();
            ps = cn.prepareStatement(sql);
            ps.executeUpdate();
            JOptionPane.showMessageDialog(null,"Programa actualizado");
             ...
             JOptionPane.showMessageDialog(null,"Programa no pudo ser actualizado"+e.getMessage());
        }
        return false;
    }

    @Override
    public boolean eliminarpro(int codprogra) {
        String sql="delete from programa where codprograma="+codprogra;
        try{
            cn = co.getConnection();
            ps = cn.prepareStatement(sql);
            ps.executeUpdate();
            ...
            JOptionPane.showMessageDialog(null,"Programa no pudo ser eliminado");
        }
        return false;
    }
