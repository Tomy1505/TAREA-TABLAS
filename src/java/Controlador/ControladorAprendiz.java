...
public class ControladorAprendiz extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(action.equalsIgnoreCase("Registrar")){
            ...
            id=Integer.parseInt(request.getParameter("ide"));
            int documento = Integer.parseInt(request.getParameter("doce"));
            String nombre = request.getParameter("nome");
            String apellido = request.getParameter("apee");
            String email = request.getParameter("emae");
            int telefono = Integer.parseInt(request.getParameter("nume"));
            ape.setId(id);
            ape.setDoca(documento);
            ape.setNoma(nombre);
            ape.setApea(apellido);
            ape.setEmaa(email);
            ape.setTela(telefono);
